...
var ApecoinStakingABI abi.ABI

func init() {
	_abi, err := abi.JSON(strings.NewReader(apecoinStakingABIJson))
	if err != nil {
		panic("Failed to parse ABI")
	}
	ApecoinStakingABI = _abi
}

type DepositNftLog struct {
	User    common.Address // indexed
	PoolId  *big.Int       // indexed
	Amount  *big.Int
	TokenId *big.Int
}

type DepositPairNftLog struct {
	User           common.Address // indexed
	Amount         *big.Int
	MainTypePoolId *big.Int
	MainTokenId    *big.Int
	BakcTokenId    *big.Int
}

type WithdrawNftLog struct {
	User      common.Address // indexed
	PoolId    *big.Int       // indexed
	Amount    *big.Int
...
type WithdrawPairNftLog struct {
	User           common.Address // indexed
	Amount         *big.Int
	MainTypePoolId *big.Int
	MainTokenId    *big.Int
...
func ToDepositNftLog(log *types.Log) (*DepositNftLog, error) {
	var l DepositNftLog
	if err := ApecoinStakingABI.UnpackIntoInterface(&l, "DepositNft", log.Data); err != nil {
		return nil, err
	}
	l.User = common.BytesToAddress(log.Topics[1].Bytes())
	l.PoolId = log.Topics[2].Big()
	return &l, nil
}

func ToDepositPairNftLog(log *types.Log) (*DepositPairNftLog, error) {
	var l DepositPairNftLog
	if err := ApecoinStakingABI.UnpackIntoInterface(&l, "DepositPairNft", log.Data); err != nil {
		return nil, err
	}
	l.User = common.BytesToAddress(log.Topics[1].Bytes())
	return &l, nil
...
func ToWithdrawNftLog(log *types.Log) (*WithdrawNftLog, error) {
	var l WithdrawNftLog
	if err := ApecoinStakingABI.UnpackIntoInterface(&l, "WithdrawNft", log.Data); err != nil {
		return nil, err
	}
	l.User = common.BytesToAddress(log.Topics[1].Bytes())
	l.PoolId = log.Topics[2].Big()
...
func ToWithdrawPairNftLog(log *types.Log) (*WithdrawPairNftLog, error) {
	var l WithdrawPairNftLog
	if err := ApecoinStakingABI.UnpackIntoInterface(&l, "WithdrawPairNft", log.Data); err != nil {
		return nil, err
	}
	l.User = common.BytesToAddress(log.Topics[1].Bytes())
	return &l, nil
